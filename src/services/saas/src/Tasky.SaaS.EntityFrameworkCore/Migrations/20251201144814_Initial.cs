        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MonthlyCurrency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false, defaultValue: "USD"),
                    YearlyPrice = table.Column<decimal>(type: "numeric(18,2)", nullable: false),
                    YearlyCurrency = table.Column<string>(type: "character varying(3)", maxLength: 3, nullable: false, defaultValue: "USD"),
                    ...
                    APICallsPerMonth = table.Column<int>(type: "integer", nullable: false),
                    EnableAdvancedReports = table.Column<bool>(type: "boolean", nullable: false),
                    EnablePrioritySupport = table.Column<bool>(type: "boolean", nullable: false),
                    EnableCustomBranding = table.Column<bool>(type: "boolean", nullable: false),
                    ExtraProperties = table.Column<string>(type: "text", nullable: false),
                    ConcurrencyStamp = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false),
                    CreationTime = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    CreatorId = table.Column<Guid>(type: "uuid", nullable: true),
