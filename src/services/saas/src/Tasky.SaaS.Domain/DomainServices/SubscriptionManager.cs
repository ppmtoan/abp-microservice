...
namespace Tasky.SaaS.DomainServices;
...
public class SubscriptionManager : DomainService
{
        ...
        int? trialDays = null)
    {
        ...
        {
            throw new BusinessException(SaaSErrorCodes.TenantAlreadyHasActiveSubscription)
        ...
        {
            throw new BusinessException(SaaSErrorCodes.InvalidSubscriptionPrice)
    ...
    public async Task RenewSubscriptionAsync(Subscription subscription)
    {
        ...
        {
            throw new BusinessException(SaaSErrorCodes.CannotRenewSubscription)
        ...
        if (!edition.IsActive)
        {
            throw new BusinessException(SaaSErrorCodes.EditionNotActive)
        ...
        DateTime upgradeDate)
    {
        ...
        {
            throw new BusinessException(SaaSErrorCodes.CannotUpgradeInactiveSubscription)
        ...
        Guid newEditionId)
    {
        ...
        if (currentSubscription.Status != SubscriptionStatus.Active)
        {
            throw new BusinessException(SaaSErrorCodes.CannotDowngradeInactiveSubscription)
                .WithData("SubscriptionId", currentSubscription.Id)
                .WithData("Status", currentSubscription.Status);
        }
    ...
    public void SuspendSubscription(Subscription subscription, string reason)
    {
        ...
        if (subscription.Status != SubscriptionStatus.Active)
        {
            throw new BusinessException(SaaSErrorCodes.CannotSuspendInactiveSubscription)
                .WithData("SubscriptionId", subscription.Id)
                .WithData("Status", subscription.Status);
        }
