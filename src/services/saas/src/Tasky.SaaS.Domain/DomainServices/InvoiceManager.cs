...
public class InvoiceManager : DomainService
{
        ...
        int sequenceNumber)
    {
        ...
        {
            throw new BusinessException(SaaSErrorCodes.CannotInvoiceInactiveSubscription)
        ...
        string description)
    {
        ...
        {
            throw new BusinessException(SaaSErrorCodes.InvalidInvoiceAmount)
        ...
        string reason)
    {
        ...
        {
            throw new BusinessException(SaaSErrorCodes.InvalidCreditAmount)
